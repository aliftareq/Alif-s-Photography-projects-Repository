        ...
        <section className='flex justify-center my-5 mx-5'>
            <div className="w-full max-w-lg p-4 rounded-md shadow sm:p-8 bg-gray-900 text-gray-100">
                ...
                <p className="text-sm text-center dark:text-gray-400">Dont have account?
                    <Link to="/register" className="ml-1 text-blue-500 focus:underline hover:underline">Register</Link>
                </p>
                ...
                <form novalidate="" action="" className="space-y-8 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between">
                                ...
                                <Link rel="noopener noreferrer" to="/login" className="text-xs hover:underline text-gray-400">Forgot password?</Link>
                            </div>
                    ...
                    <button type="button" className="w-full px-8 py-3 font-semibold rounded-md bg-violet-400 text-gray-900">Login</button>
                </form>
            </div>
        </section>
    );
