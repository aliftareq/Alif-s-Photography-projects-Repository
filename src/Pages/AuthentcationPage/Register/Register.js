                ...
                <form novalidate="" action="" className="space-y-8 ng-untouched ng-pristine ng-valid">
                    <div className="space-y-4">
                        <div className="space-y-2">
                            <label for="name" className="block text-sm text-start">Name</label>
                        ...
                        <div className="space-y-2">
                            <label for="Photo" className="block text-sm text-start">Photo URL</label>
                            <input type="text" name="photo" id="photo" placeholder="Enter a photo url" className="w-full px-3 py-2 border rounded-md border-gray-700 bg-gray-900 text-gray-100 focus:border-violet-400" />
                        </div>
                        <div className="space-y-2">
